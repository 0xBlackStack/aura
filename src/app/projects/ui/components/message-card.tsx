...
const UserMessage = ({ content }: UserMessageProps) => {
    return (
        <div className="flex justify-end pb-4 pr2 pl-10">
...
const FragmentCard = ({
    ...
    return (
        <button className={cn(
            "flex items-start text-start gap-2 border rounded-lg muted w-fti p-3 hover:bg-secondary transition-colors",
            ...
            <div className="pl-8.5 flex flex-col gap-y-4">
                <span>
                    ...
                    {fragment && type === "RESULT" && (
                        <FragmentCard fragment={fragment} isActive={isActive} onFragmentClick={onFragmentClick} />
                    )}
                </span>
            </div>
        </div>
